...
# get probabilities of people being in the same household
```{r husstande}
husstande <- read.csv("husstandsstørrelse2012-2022.csv",header=TRUE) #read in the houshold data
hus <- husstande %>% 
  rowwise() %>% 
...
---- This does the same as all code above --- 
...
n_seats <- 8      # number of seats per table
...
round_tables$new_seat <-paste(round_tables$table, round_tables$seat, sep='') #Giving all seats at the party a unique ID
