...
#round
round_tables <- tibble(expand.grid(table = seq(n_tables), seat = seq(n_seats), contact_seats = 1:2))

#square
square_tables <- tibble(expand.grid(table = seq(n_tables), seat = seq(n_seats), contact_seats = 1:5))

#long
long_start <- tibble(expand.grid(table = 1, seat = 1:n_people, contact_seats = 1:5))

#works but end seating have weird corner seats...
